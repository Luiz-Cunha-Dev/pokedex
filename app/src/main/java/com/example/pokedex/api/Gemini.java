    ...
    public void identifyPokemonInImage(Uri imageUri, Context context, PokemonIdentificationCallback callback) {
        try {
            ...
            Content content = new Content.Builder()
                    .addText("Identify the Pokémon in the image. Your answer should only contain the name of the identified Pokémon, nothing else.Identify the Pokémon in the image. Your answer should only contain the name of the identified Pokémon, nothing else.")
                    .addImage(image)
                    .build();
            ...
            Futures.addCallback(response, new FutureCallback<GenerateContentResponse>() {
                ...
                public void onSuccess(GenerateContentResponse result) {
                    ...
                    System.out.println("Identified Pokémon: " + resultText);
